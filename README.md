## Playwright MCP
[![smithery badge](https://smithery.ai/badge/@ahai72160/playwright-mcp)](https://smithery.ai/server/@ahai72160/playwright-mcp)
...
To install Playwright MCP for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@ahai72160/playwright-mcp):

```bash
npx -y @smithery/cli install @ahai72160/playwright-mcp --client claude
```
